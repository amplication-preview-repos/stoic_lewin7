...
export class AppointmentResolverBase {
  ...
  async createAppointment(
    ...
    return await this.service.createAppointment({
      ...
      data: {
        ...
        staff: args.data.staff
          ? {
              connect: args.data.staff,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => Staff, {
    nullable: true,
    name: "staff",
  })
  async getStaff(@graphql.Parent() parent: Appointment): Promise<Staff | null> {
    const result = await this.service.getStaff(parent.id);
